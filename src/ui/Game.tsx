  ...
  return (
    <div className="tycoon-shell" style={{ minHeight: "100vh", background: C.bg, color: C.ink }}>
      <style>{`
        ...
        *{font-family:Inter,ui-sans-serif,system-ui,-apple-system,'Segoe UI',Roboto,sans-serif;box-sizing:border-box;}
        ...
        .tycoon-shell{background:radial-gradient(circle at 50% -180px,#d9edff 0,#edf3f9 38%,#edf3f9 100%)!important;}
        ...
        .play-surface{height:100vh;overflow:hidden;position:relative;background:#dfe8e2}.campus-world{position:absolute;left:0;right:0;top:72px;bottom:0;overflow:hidden}
        ...
        @media(max-width:780px){.campus-world{top:108px}.left-rail{top:auto;bottom:8px;left:8px;right:8px;display:flex;justify-content:space-between}.left-rail button{width:auto;flex:1;min-height:46px}.left-rail button small{font-size:7px}.screen-overlay{inset:108px 0 0;padding:6px}.overlay-card{width:100%;height:calc(100vh - 120px);border-radius:13px}.event-toast{left:8px;right:8px;bottom:66px;max-width:none}}
