...
const EXTERNAL_IP_SEEDS: ExternalIPSeed[] = [
  { id: "space_opera", name: "Galaxy Knights", ownerName: "Northstar Pictures", awareness: .82, momentum: 1.24, prestige: .84, fatigue: .14, audiencePresetId: "broad_pop", compatibleProductFamilies: ["actionfig","buildingset","vehicle","collectible","plush","boardgame","electronictoy","cereal","candy","tshirt","hoodie","kidsapparel","controller","headphones"], royaltyRate: .095, minimumGuarantee: 520_000 },
  { id: "superhero", name: "Titan Heroes Universe", ownerName: "Titan Media", awareness: .91, momentum: 1.16, prestige: .88, fatigue: .28, audiencePresetId: "broad_pop", compatibleProductFamilies: ["actionfig","buildingset","vehicle","collectible","plush","boardgame","electronictoy","cereal","snackbar","candy","tshirt","hoodie","kidsapparel","controller"], royaltyRate: .105, minimumGuarantee: 720_000 },
  { id: "princess_magic", name: "Enchanted Kingdoms", ownerName: "Crownlight Entertainment", awareness: .88, momentum: 1.08, prestige: .82, fatigue: .22, audiencePresetId: "kids_family", compatibleProductFamilies: ["doll","plush","buildingset","collectible","boardgame","mask","hydration","cereal","candy","tshirt","hoodie","kidsapparel","handbag"], royaltyRate: .10, minimumGuarantee: 650_000 },
  { id: "animated_kids", name: "Sunny Pals", ownerName: "Sunbeam Animation", awareness: .70, momentum: 1.34, prestige: .58, fatigue: .10, audiencePresetId: "kids_family", compatibleProductFamilies: ["plush","doll","boardgame","buildingset","actionfig","cereal","snackbar","cookies","candy","tshirt","kidsapparel"], royaltyRate: .075, minimumGuarantee: 310_000 },
  { id: "monster_world", name: "Creature Realms", ownerName: "Midnight Forge", awareness: .74, momentum: 1.42, prestige: .68, fatigue: .08, audiencePresetId: "teen_fandom", compatibleProductFamilies: ["actionfig","collectible","buildingset","boardgame","plush","electronictoy","cereal","candy","tshirt","hoodie","controller"], royaltyRate: .085, minimumGuarantee: 380_000 },
  { id: "fantasy_saga", name: "Realm of Crowns", ownerName: "Silver Quill Studios", awareness: .76, momentum: .98, prestige: .91, fatigue: .07, audiencePresetId: "adult_premium", compatibleProductFamilies: ["actionfig","collectible","buildingset","boardgame","doll","tshirt","hoodie","handbag"], royaltyRate: .085, minimumGuarantee: 420_000 },
  { id: "retro_arcade", name: "Retro Arcade Classics", ownerName: "Vector Interactive", awareness: .52, momentum: 1.12, prestige: .62, fatigue: .05, audiencePresetId: "nostalgia", compatibleProductFamilies: ["electronictoy","collectible","actionfig","buildingset","boardgame","tshirt","hoodie","controller","headphones"], royaltyRate: .055, minimumGuarantee: 120_000 },
  { id: "global_soccer", name: "World Football League", ownerName: "World Football Licensing", awareness: .90, momentum: 1.05, prestige: .86, fatigue: .18, audiencePresetId: "broad_pop", compatibleProductFamilies: ["actionfig","collectible","boardgame","vehicle","cereal","snackbar","tshirt","hoodie","activewear","kidsapparel","controller"], royaltyRate: .09, minimumGuarantee: 600_000 },
  { id: "global_basket", name: "Pro Basketball Association", ownerName: "PBA Properties", awareness: .83, momentum: 1.18, prestige: .80, fatigue: .14, audiencePresetId: "teen_fandom", compatibleProductFamilies: ["actionfig","collectible","boardgame","cereal","snackbar","tshirt","hoodie","activewear","kidsapparel","controller"], royaltyRate: .085, minimumGuarantee: 510_000 },
  { id: "racing_cars", name: "Speedway Legends", ownerName: "Velocity Rights", awareness: .67, momentum: 1.08, prestige: .72, fatigue: .11, audiencePresetId: "broad_pop", compatibleProductFamilies: ["vehicle","buildingset","collectible","actionfig","electronictoy","cereal","tshirt","hoodie","controller","headphones"], royaltyRate: .07, minimumGuarantee: 260_000 },
  { id: "pop_music", name: "Global Pop Icons", ownerName: "Pulse Entertainment", awareness: .89, momentum: 1.52, prestige: .73, fatigue: .31, audiencePresetId: "teen_fandom", compatibleProductFamilies: ["doll","collectible","plush","mask","hydration","candy","tshirt","hoodie","handbag","headphones","earbuds","smartspeaker"], royaltyRate: .11, minimumGuarantee: 760_000 },
  { id: "indie_comics", name: "Indie Comics Universe", ownerName: "Panel House", awareness: .34, momentum: 1.26, prestige: .48, fatigue: .03, audiencePresetId: "teen_fandom", compatibleProductFamilies: ["actionfig","collectible","boardgame","tshirt","hoodie","controller"], royaltyRate: .045, minimumGuarantee: 65_000 },
  { id: "nature_doc", name: "Planet Wild", ownerName: "Terra Documentary Group", awareness: .46, momentum: .93, prestige: .70, fatigue: .02, audiencePresetId: "adult_premium", compatibleProductFamilies: ["plush","boardgame","buildingset","sunscreen","cereal","snackbar","tshirt","kidsapparel","activewear"], royaltyRate: .04, minimumGuarantee: 55_000 },
  { id: "local_sport", name: "National League", ownerName: "National League Properties", awareness: .43, momentum: 1.02, prestige: .47, fatigue: .09, audiencePresetId: "broad_pop", compatibleProductFamilies: ["actionfig","collectible","boardgame","tshirt","hoodie","activewear","snackbar","controller"], royaltyRate: .045, minimumGuarantee: 80_000 },
  { id: "cooking_show", name: "Master Kitchen", ownerName: "Tabletop Media", awareness: .38, momentum: 1.10, prestige: .45, fatigue: .08, audiencePresetId: "broad_pop", compatibleProductFamilies: ["boardgame","doll","mask","cereal","snackbar","cookies","readymeal"], royaltyRate: .04, minimumGuarantee: 70_000 },
];
