...
export function effectiveAttributes(industryId: string, pkgKey: string, attributes: Record<string, number>, _legacyLicenseKey?: string | null): Record<string, number> {
